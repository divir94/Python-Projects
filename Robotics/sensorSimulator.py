...
class Map:
    ...
    def getExactImage(self, cx, cy, thd, f=1.0):
        ...
        smallestgap = 0.5 * min( list(map( lambda x,y: y-x, sortedfeats[:-1], sortedfeats[1:] )) )
    ...
    def adjustPose(self, xxx_todo_changeme, costhr, sinthr, cx, cy):
